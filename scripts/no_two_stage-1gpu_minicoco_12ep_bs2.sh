...
exp_code=no_two_stage-shortersize_480-${device_code}_${dataset}-msdetr_baseline_${backbone}_enc${num_enc_layers}_dec${num_dec_layers}_query${num_queries}-bs${batch_size}x${num_gpus}
