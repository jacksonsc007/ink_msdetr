...
exp_code=shortersize480-${device_code}_${dataset}-cascade_msdetr_baseline_no_twp_stage_${backbone}_enc${num_enc_layers}_dec${num_dec_layers}_query${num_queries}-bs${batch_size}
