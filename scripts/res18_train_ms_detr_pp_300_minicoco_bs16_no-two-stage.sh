...
exp_code=shortersize_480-${device_code}_${dataset}-msdetr_baseline-no_two_stage_${backbone}_enc${num_enc_layers}_dec${num_dec_layers}_query${num_queries}-bs${batch_size}
