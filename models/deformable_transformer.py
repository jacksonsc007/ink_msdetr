...
class DeformableTransformer(nn.Module):
    ...
    def forward(self, srcs, masks, pos_embeds, query_embed=None, extra_query_embed=None, **kwargs):
        ...
        src_flatten = self.multi_scale_sampler(src_flatten, enc_reference_points, spatial_shapes, level_start_index, mask_flatten)
        ...
        # encoder
        memory, _ = self.encoder(src_flatten, spatial_shapes, level_start_index, valid_ratios, lvl_pos_embed_flatten, mask_flatten)
